...
const productPath = `/compileflow-material@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('compileflow-material', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'compileflow-material': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
