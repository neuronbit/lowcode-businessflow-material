...
const productPath = `/lowcode-businessflow-material@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('lowcode-businessflow-material', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'lowcode-businessflow-material': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
